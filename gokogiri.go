...
import (
	"github.com/Jberlinsky/gokogiri/html"
	"github.com/Jberlinsky/gokogiri/xml"
)
...
found in the github.com/Jberlinsky/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
